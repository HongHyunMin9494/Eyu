...
Shader "OG/Effect/UV_Dynamatic_Mask" {
    ...
    SubShader {
        ...
        Pass {
            ...
            Blend SrcAlpha [DstBlend], One OneMinusSrcAlpha
            Cull[_Cull]
            ZWrite Off
            ZTest[_ZTest]
            ...
            uniform float _MainTexTurbulenceScale;
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float smoothstepResult = smoothstep( ( 1.0 - _Dissolve_Tex_smooth ) , _Dissolve_Tex_smooth , saturate( ( ( _TurbulenceTex_var.r + 1.0 ) - ( i.uv1.b * 2.0 ) ) ));
				
////// Lighting:
////// Emissive:
                float2 node_407 = (_TurbulenceTex_var.r * _MainTexTurbulenceScale + i.uv0 + float2(i.uv1.r, i.uv1.g));
                ...
                float4 _MaskTex_var = tex2D(_MaskTex, TRANSFORM_TEX(i.uv0 + float2(i.uv1.a, 0), _MaskTex));
                //return fixed4(finalColor, _MainColor.a * i.vertexColor.a * _MainTex_var.a * _MaskTex_var.r *  smoothstepResult);
                float alpha = _MainColor.a * i.vertexColor.a * _MainTex_var.a * _MaskTex_var.r *  smoothstepResult;
                //clip(alpha - 0.5);
                //finalColor *= alpha;
