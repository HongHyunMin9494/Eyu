...
Shader "OG/Effect/Fresnel_Mask" {
    Properties {
		...
		[Enum(UnityEngine.Rendering.BlendMode)] DstBlend ("DstBlend", Float) = 10//OneMinusAlpha
...
////// Emissive:
                ...
                float2 node_5383 = (i.uv0+float2(i.uv1.r,i.uv1.g));
                float4 _Mask_var = tex2D(_Mask,TRANSFORM_TEX(node_5383, _Mask));
                return fixed4(finalColor,saturate((_MainColor.a*(i.vertexColor.a*lerp( _MainTex_var.a, (_MainTex_var.a*node_4229), _FresnelMultiplyAlpha ))*_Mask_var.r)));
            }
            ENDCG
        }
    }
